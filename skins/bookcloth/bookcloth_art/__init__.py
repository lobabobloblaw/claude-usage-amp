"""bookcloth_art -- everything the Bookcloth skin is painted with.

palette.py    colour ramps (paper, ink, cloth, kraft, thread, accents)
plate.py      a window-coordinate drawing wrapper around skinkit's Canvas
